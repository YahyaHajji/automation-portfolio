...
| [Smart UPF Multi-Agent Assistant](projects/smart-upf-multi-agent-assistant/) | Routes university questions through specialist AI agents, supervisor validation, caching, logging, and observability. | n8n, Ollama, Redis, PostgreSQL, MCP, Grafana |
